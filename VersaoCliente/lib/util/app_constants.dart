...
class AppConstants {
  static const String appName = 'Fastbite Delivery';
  static const double appVersion = 7.6;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const String webHostedUrl = 'https://fastbiteus.com';

  static const String baseUrl = 'https://admin.fastbiteus.com';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'Português', countryCode: 'Pt-BR', languageCode: 'pt'),
