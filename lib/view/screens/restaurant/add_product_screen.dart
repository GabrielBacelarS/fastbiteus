...
class AddProductScreen extends StatefulWidget {
  ...
  const AddProductScreen(
      {Key? key, required this.product, required this.translations})
      : super(key: key);
...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      _product = Product(stockType: "unlimited");
                      ...
                      ? CustomButton(
                          ...
                          onPressed: () {
                            ...
                            if (price.isEmpty) {
                              ...
                              _product!.stockType =
                                  "unlimited"; // Defina o stockType antes de enviar
                              ...
                              _product!.translations!
                                  .addAll(widget.translations);

                              print('Stock Type: ${_product!.stockType}');
