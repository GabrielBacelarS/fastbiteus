...
import 'package:efood_multivendor_restaurant/data/model/response/disbursement_method_model.dart' as d;
import 'package:efood_multivendor_restaurant/data/model/response/disbursement_report_model.dart' as r;
...
import 'package:efood_multivendor_restaurant/view/screens/disbursements/widget/withdraw_method_attention_dialog.dart';
  ...
  Future<bool> enableDisbursementWarningMessage(bool fromDashboard, {bool canShowDialog = true}) async {
    ...
    if(Get.find<SplashController>().configModel!.disbursementType == 'automated'){
     await getDisbursementMethodList().then((success) {
        if(success){
          if(disbursementMethodBody!.methods!.isNotEmpty){
