...
class AppConstants {
  static const String appName = 'Deliveryboy'; //Download from Scriptzhub.com
  static const double appVersion = 7.2;

  static const String baseUrl = 'https://admin.fastbiteus.com'; //Download from Scriptzhub.com
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'Português', countryCode: 'BR', languageCode: 'pt'),
