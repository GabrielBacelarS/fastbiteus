                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            InkWell(
                              onTap: () {
                                if(authController.profileModel!.showPayNowButton!){
                                  ...
                                  }else if(Get.find<SplashController>().configModel!.minAmountToPayDm! > authController.profileModel!.payableBalance!){
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                  color: authController.profileModel!.showPayNowButton! ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withOpacity(0.8),
                                ),
